...
class MiniLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MiniLangParser#fromStmt.
    def enterFromStmt(self, ctx:MiniLangParser.FromStmtContext):
        pass

    # Exit a parse tree produced by MiniLangParser#fromStmt.
    def exitFromStmt(self, ctx:MiniLangParser.FromStmtContext):
        pass
